...
function PlanStep2({ imageSrc, name, dollar }) {
    return (
        <div className='p-4 w-[100%] h-[100%] rounded-md border-[1px] bg-white hover:bg-[rgb(229,244,246)] border-[rgb(188,193,211)] hover:border-[rgb(25,54,95)]'>
